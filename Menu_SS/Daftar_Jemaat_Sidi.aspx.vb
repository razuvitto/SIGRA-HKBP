...
Imports System.IO
Partial Class Daftar_Jemaat_Sidi
    ...
    Protected Sub Insert()
        ...
        Using con As New SqlConnection(constr)
            Using cmd As New SqlCommand("daftar_jemaat_sidi_CRUD")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.AddWithValue("@Action", "INPUT_SIDI")
                ...
                cmd.Parameters.AddWithValue("@tanggal_sidi", txtDatesidi)
                ...
                cmd.Parameters.AddWithValue("@pendeta_baptis", "")
                cmd.Parameters.AddWithValue("@pendeta_sidi", txt_pendetasidi.Text)
                cmd.Parameters.AddWithValue("@terlaksana_baptis", "")
                cmd.Parameters.AddWithValue("@terlaksana_sidi", "Request")
                cmd.Parameters.AddWithValue("@nama_gereja_baptis", "")
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Insert()
        Response.Redirect("~/Menu_SS/Jemaat_sidi.aspx")
    End Sub
End Class