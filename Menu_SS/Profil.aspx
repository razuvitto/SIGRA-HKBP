<%@ Page Title="Profil" Language="VB" MasterPageFile="~/Menu_SS/Site_SS.master" AutoEventWireup="true" CodeFile="~/Menu_SS/Profil.aspx.vb" Inherits="profil" %>
...
<div Class="row">
    ...
    <div class="jumbotron" style="font-size:medium">
        ...
        <br />
   <asp:Button ID="ubah_password" runat="server" Text="Ubah Password" PostBackUrl="~/Menu_SS/ubah_password.aspx" class="btn btn-primary"/>
        </div>
        <br />
