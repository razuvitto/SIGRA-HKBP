...
#Region "searching"
    ...
    Private Sub getCustRecords(searchBy As String, searchVal As String)
        ...
        cmd = New SqlCommand("daftar_jemaat_baptis_CRUD", constr)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@Action", "SELECT_JEMAAT_BAPTIS_REQUEST")
        ...
        cmd.Parameters.AddWithValue("@id_baptis", "")
...
#End Region
    ...
    Protected Sub OnSelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        Session("select_id_ baptis") = CustGrid.SelectedRow.Cells(0).Text.ToString
    End Sub
    ...
    End Sub
    Protected Sub Accept()
        Dim constr As String = ConfigurationManager.ConnectionStrings("constr").ConnectionString
        Using con As New SqlConnection(constr)
            Using cmd As New SqlCommand("daftar_jemaat_baptis_CRUD")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.AddWithValue("@Action", "Accept_Baptis")
                cmd.Parameters.AddWithValue("@id_baptis", Session("select_id_ baptis"))
                cmd.Parameters.AddWithValue("@id_jemaat", "")
                cmd.Parameters.AddWithValue("@id_sektor", "")
                cmd.Parameters.AddWithValue("@nama", "")
                cmd.Parameters.AddWithValue("@jenis_kelamin", "")
    ...
    Protected Sub Reject()
        ...
        Using con As New SqlConnection(constr)
            Using cmd As New SqlCommand("daftar_jemaat_baptis_CRUD")
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.AddWithValue("@Action", "Reject_Baptis")
                cmd.Parameters.AddWithValue("@id_baptis", Session("select_id_ baptis"))
                cmd.Parameters.AddWithValue("@id_sektor", "")
                cmd.Parameters.AddWithValue("@id_jemaat", "")
                cmd.Parameters.AddWithValue("@nama", "")
    ...
    Protected Sub btnAccept_Click(sender As Object, e As EventArgs) Handles btnAccept.Click
        Accept()
        Response.Redirect("~/Menu_SS/Jemaat_Baptis")
    End Sub
