<%@ Page Title="Jemaat Baptis" EnableEventValidation="false" Language="VB" MasterPageFile="~/Menu_SS/Site_SS.master" AutoEventWireup="true" CodeFile="~/Menu_SS/Jemaat_Baptis.aspx.vb" Inherits="Jemaat_Baptis" %>
...
<div Class="row">
    <h2><%: Title %></h2> 
    <br />
        <asp:Button ID="buat_kegiatan" runat="server" Text="Pendaftaran Jemaat Baptis" PostBackUrl="~/Menu_SS/Daftar_Jemaat_Baptis.aspx" class="btn btn-primary"/>
