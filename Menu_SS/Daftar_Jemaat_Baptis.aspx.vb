...
Imports System.IO
Partial Class Daftar_Jemaat_Baptis
    ...
    Protected Sub Insert()
        ...
        Using con As New SqlConnection(constr)
            Using cmd As New SqlCommand("Input_JemaatBaru")
                ...
                cmd.Parameters.AddWithValue("@pendeta_sidi", "")
                cmd.Parameters.AddWithValue("@terlaksana_baptis", "Request")
                cmd.Parameters.AddWithValue("@terlaksana_sidi", "")
                cmd.Parameters.AddWithValue("@nama_gereja_baptis", txt_namagerejabaptis.Text)
                cmd.Parameters.AddWithValue("@nama_gereja_sidi", "")
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Insert()
        Response.Redirect("~/Menu_SS/Jemaat_Baptis.aspx")
    End Sub
End Class