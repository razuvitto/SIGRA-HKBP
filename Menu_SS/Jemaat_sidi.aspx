<%@ Page Title="Jemaat Sidi" EnableEventValidation="false" Language="VB" MasterPageFile="~/Menu_SS/Site_SS.master" AutoEventWireup="true" CodeFile="~/Menu_SS/Jemaat_sidi.aspx.vb" Inherits="Jemaat_Sidi" %>
...
<div Class="row">
    <h2><%: Title %></h2> 
    <br />
        <asp:Button ID="buat_kegiatan" runat="server" Text="Pendaftaran Jemaat Sidi" PostBackUrl="~/Menu_SS/Daftar_Jemaat_Sidi.aspx" class="btn btn-primary"/>
