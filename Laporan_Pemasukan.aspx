<%@ Page Title="Laporan Pemasukan" Language="VB" MasterPageFile="Site_Unregist.master" AutoEventWireup="true" CodeFile="Laporan_Pemasukan.aspx.vb" Inherits="Laporan_pemasukan" %>


<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %></h2>
    <div class="jumbotron">
        <h2 style="text-align:left;font-size:20px">Grafik Pemasukan</h2>
    ...
    <div class="jumbotron">
        <h2 style="text-align:left;font-size:20px">Data Pemasukan</h2>
       <div>
        ...
        <Columns>
            <asp:TemplateField HeaderText="Nama Pemasukan" ItemStyle-Width="500" HeaderStyle-BackColor="Transparent" HeaderStyle-Font-Bold="True">
                <ItemTemplate>
     ...
     <asp:Button ID="Button1" runat="server" Text="Kembali" CssClass="btn btn-primary" PostBackUrl="Statistik_keuangan.aspx"/>
</asp:Content>
