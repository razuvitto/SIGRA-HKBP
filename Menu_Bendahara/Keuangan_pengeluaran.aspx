<%@ Page Title="Data Pengeluaran" EnableEventValidation="false" Language="VB" MasterPageFile="~/Menu_Bendahara/Site_Bendahara.master" AutoEventWireup="true" CodeFile="~/Menu_Bendahara/Keuangan_pengeluaran.aspx.vb" Inherits="Keuangan_pengeluaran" %>
...
<div Class="row">
    <h2><%: Title %></h2>
    <br />
    <asp:Button ID="btnbuat" runat="server" Text="Tambah Pengeluaran" CssClass="btn btn-primary" PostBackUrl="~/Menu_Bendahara/Buat_pengeluaran.aspx"/>
   ...
   <asp:GridView ID="pemasukan" runat="server" AutoGenerateColumns="false" DataKeyNames="id_transaksi" BorderColor="Transparent"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Jumlah" ItemStyle-Width="450">
                <ItemTemplate>
                    <asp:Label ID="lbljudul" runat="server" Text='<%# Eval("kredit") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>        
