<%@ Page Title="Kegiatan Yang Akan Datang" Language="VB" MasterPageFile="~/Menu_Bendahara/Site_Bendahara.master" AutoEventWireup="true" CodeFile="~/Menu_Bendahara/kegiatan.aspx.vb" Inherits="Kegiatan" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">


<div Class="row">
    <h2 style = "font-size:20px" >KEGIATAN YANG AKAN DATANG</h2> 
        <br />
    ...
    <asp:GridView ID="kegiatan" runat="server" AutoGenerateColumns="false" DataKeyNames="id_kegiatan" BorderColor="Transparent"  RowStyle-BackColor="#C3C3C3" AlternatingRowStyle-BackColor="White" AlternatingRowStyle-ForeColor="#000"
        ...
        <br />
        <asp:Button ID="buat_kegiatan" runat="server" Text="Tambah Kegiatan" PostBackUrl="~/Buat_kegiatan.aspx" class="btn btn-primary"/>
</asp:Content>
