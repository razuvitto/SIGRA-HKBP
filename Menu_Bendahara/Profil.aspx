<%@ Page Title="Profil" Language="VB" MasterPageFile="~/Menu_Bendahara/Site_Bendahara.master" AutoEventWireup="true" CodeFile="~/Menu_Bendahara/Profil.aspx.vb" Inherits="profil" %>
...
<div Class="row">
    ...
    <div class="jumbotron" style="font-size:medium">
        ...
        <br />
   <asp:Button ID="ubah_password" runat="server" Text="Ubah Password" PostBackUrl="~/Menu_Bendahara/ubah_password.aspx" class="btn btn-primary"/>
        </div>
        <br />
