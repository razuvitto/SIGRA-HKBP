<%@ Page Title="Pengumuman" EnableEventValidation="false" Language="VB" MasterPageFile="~/Menu_PG/Site_PG.master" AutoEventWireup="true" CodeFile="~/Menu_PG/Pengumuman.aspx.vb" Inherits="Pengumuman" %>
        ...
        <asp:GridView ID="all_pengumuman" runat="server" AutoGenerateColumns="false" DataKeyNames="id_pengumuman" BorderColor="Transparent"  EmptyDataText="Data Belum Ditambahkan">
                <Columns>       
                    <%--<asp:BoundField DataField="id_pengumuman" HeaderText="ID" ItemStyle-Width = "60" />--%>
                        <asp:HyperLinkField DataTextField="Judul_pengumuman" DataNavigateUrlFields="Id_pengumuman" DataNavigateUrlFormatString="~/Menu_PG/Detail_pengumuman.aspx?Id{0}" HeaderText="Judul" ItemStyle-Width = "650" HeaderStyle-BackColor="Transparent"/>            
