<%@ Page Title="Profil Gereja" Language="VB" EnableEventValidation="false" MasterPageFile="~/Menu_PG/Site_PG.master" AutoEventWireup="true" CodeFile="~/Menu_PG/Tentang.aspx.vb" Inherits="Tentang" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="edit_profil" runat="server" Text="Edit Profil Gereja" PostBackUrl="~/Menu_PG/edit_profil_gereja.aspx" class="btn btn-primary"/>
</asp:Content>
