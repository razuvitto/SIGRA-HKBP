...
Partial Class Jemaat_JemaatBaru
...
#Region "searching"
    ...
    Private Sub getCustRecords(searchBy As String, searchVal As String)
        ...
        cmd.Parameters.AddWithValue("@Action", "SELECT_JEMAAT_REQUEST")
...
#End Region
    ...
    Protected Sub OnSelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        Session("select_id_jemaat") = CustGrid.SelectedRow.Cells(0).Text.ToString
    End Sub
    ...
    Protected Sub Accept()
        ...
        Using con As New SqlConnection(constr)
            Using cmd As New SqlCommand("daftar_jemaat_baru_CRUD")
                ...
                cmd.Parameters.AddWithValue("@id_jemaat", Session("select_id_jemaat"))
                cmd.Parameters.AddWithValue("@id_sektor", "")
                cmd.Parameters.AddWithValue("@nama", "")
                cmd.Parameters.AddWithValue("@jenis_kelamin", "")
                cmd.Parameters.AddWithValue("@tanggal_lahir", "")
    ...
    Protected Sub btnAccept_Click(sender As Object, e As EventArgs) Handles btnAccept.Click
        Accept()
        Response.Redirect("~/Menu_TU/Jemaat_Jemaatbaru")
    End Sub
