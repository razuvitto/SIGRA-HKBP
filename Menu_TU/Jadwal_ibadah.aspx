<%@ Page Title="Jadwal Ibadah" Language="VB" EnableEventValidation="false" MasterPageFile="~/Menu_TU/Site_TU.master" AutoEventWireup="true" CodeFile="~/Menu_TU/Jadwal_ibadah.aspx.vb" Inherits="jadwal_ibadah" %>
...
<div Class="row">
    <h2 style = "font-size:20px" >JADWAL IBADAH</h2> 
        <br />
     <asp:Button ID="tambah_jadwal" runat="server" Text="Tambah Jadwal" PostBackUrl="~/Menu_TU/Buat_jadwal_ibadah.aspx" class="btn btn-primary"/>
    <br />
    <br />
