<%@ Page Title="Logo Gereja" Language="VB" EnableEventValidation="false" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Edit_Logo.aspx.vb" Inherits="Edit_Logo" %>
...
<div Class="row">
    ...
    <br />
     <asp:Button ID="kembali" runat="server" Text="Kembali" PostBackUrl="~/edit_profil_gereja.aspx" class="btn btn-primary"/>
