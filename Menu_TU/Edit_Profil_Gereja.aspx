<%@ Page Title="Edit Profil Gereja" EnableEventValidation="false" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Edit_Profil_Gereja.aspx.vb" Inherits="Edit_Profil_Gereja" %>
...
<div Class="row">
    ...
    <br />
    <asp:Button ID="kembali" runat="server" Text="Kembali" PostBackUrl="~/tentang.aspx" class="btn btn-primary"/>
    <asp:Button ID="btneditlogo" runat="server" CssClass="btn btn-primary" Text="Edit Logo Gereja" PostBackUrl="~/Edit_Logo.aspx"/> 
</div>
        <br />
